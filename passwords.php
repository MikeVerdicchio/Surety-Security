    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                A longer password and inclusion of symbols, numbers, uppercase, and lowercase characters expands the number of potential combinations by expanding the search space. A password containing 12 or more characters is highly reommended because at 350 billion password cracks per second would take
                <?php echo number_format(((pow(95, 12)/350000000000)/60), 2). " minutes or "; echo number_format(((pow(95, 12)/350000000000)/60/60), 2). " hours or "; echo number_format(((pow(95, 12)/350000000000)/60/60/24), 2). " days or "; echo number_format(((pow(95, 12)/350000000000)/60/60/24/365), 2). " years or "; echo number_format(((pow(95, 12)/350000000000)/60/60/24/365/1000), 2). " centuries "; echo "to break in a best case scenario.<br>" ?>A password containing padding that includes an uppercase and lowercase character, symbol, and digit like U7^d can make a strong password even stronger. Reusing passwords on sites is not recommended because even though one site might be safe, other sites might not be secure and store their passwords in plaintext or other insecure manner
                <br>
            </div>
        </div>
        <div class="row">
